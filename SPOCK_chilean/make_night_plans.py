                    ...
                    for line in file:
                        if line == ';\n':
                            ...
                            if coords.dec.deg > 80:
                                print('WARNING: field ' + target_name +
                            ...
                            if observable_elevation:
                                print('INFO: OK, field ' + target_name
                            ...
                            if abs(coords.dec.deg) > 80:
                                print('WARNING: field ' + target_name
                                      + ' is very close to polar (>80) qulity will be worst than usual')

                            if self.time_end < self.time_start:
                                sys.exit('WARNING: Start time of field '
                                         + target_name + ' is > to end time')
                            elif self.time_start < twilight_evening:
                                print('WARNING: Start time of field '
                                      + target_name + ' is < to nautical evening twilight !')
                            elif self.time_end > twilight_morning:
                                print('WARNING: End time of field '
